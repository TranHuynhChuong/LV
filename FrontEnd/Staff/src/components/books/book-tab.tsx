...
export default function BookTab({
  ...
  useEffect(() => {
    getData(page, sortType, filterType, keyword, categoryId, bookId);
    const handler = () => getData(page, sortType, filterType, keyword, categoryId, bookId);
  ...
  return (
    <div className="space-y-4 bg-white min-w-xl">
      <div className="flex items-center justify-between">
        <h1 className="pl-4 text-lg font-semibold">{totalItems} Sách</h1>
        {!isComponent && (
          <Link href="/books/new">
