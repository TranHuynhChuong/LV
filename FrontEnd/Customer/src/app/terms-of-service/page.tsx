export default function TermsOfServicePage() {
  return (
    <div className="w-full  py-10 px-6 bg-white rounded-lg shadow-md space-y-8 text-sm">
      ...
      <p className="text-justify indent-8">
        ...
        khảo hoặc mua sắm, quý khách đã đồng ý tuân thủ và ràng buộc với những quy định của Dật Lạc.
        Vui lòng xem kỹ các quy định và hợp tác với chúng tôi để xây dựng một website ngày càng thân
        thiện và phục vụ tốt những yêu cầu của quý khách. Nếu có bất kỳ câu hỏi nào, vui lòng liên
        hệ với Dật Lạc qua hotline 1900 1234 hoặc email: cskh@datlac.vn.
      </p>
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-6 space-y-2 text-justify">
          <li>
            Một số dịch vụ yêu cầu đăng ký tài khoản. Quý khách cần cung cấp dữ liệu cá nhân cơ bản
            như họ tên, email, số điện thoại để sử dụng đầy đủ tính năng.
          </li>
      ...
      <section className="space-y-3">
        ...
        <p className="text-justify">
          Dữ liệu chỉ dùng để nâng cao chất lượng dịch vụ, không chia sẻ với bên thứ ba vì mục đích
          thương mại. Nếu quý khách muốn rút lại sự đồng ý, chỉnh sửa, hoặc yêu cầu liên quan đến dữ
          liệu cá nhân, vui lòng thao tác tại website hoặc liên hệ Dật Lạc.
        </p>
        <p className="text-justify">
      ...
      <section className="space-y-3">
        ...
        <p className="text-justify">
          Chúng tôi tuân thủ nguyên tắc xử lý dữ liệu cá nhân theo quy định pháp luật và chính sách
          bảo mật. Trong trường hợp phát sinh ngoài ý muốn, chúng tôi không chịu trách nhiệm về tổn
          thất.
        </p>
        <p className="text-justify">
        ...
        <p className="text-justify">
          Nếu phát hiện lỗi hệ thống, vui lòng liên hệ hotline 1900 1234 hoặc email: cskh@datlac.vn.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-justify">
          Điều khoản này có hiệu lực từ ngày 01/06/2025. Dật Lạc có thể điều chỉnh nội dung này bất
          kỳ lúc nào và đăng tải công khai trên website. Việc tiếp tục sử dụng dịch vụ được xem như
          quý khách đã đồng ý với nội dung cập nhật.
        </p>
      </section>

      <div className="text-right mt-10 text-sm text-zinc-600 italic">
